...
var bizProcessFP = _ramda2.default.compose(_ramda2.default.join(','), _ramda2.default.map(captalize), tap, _ramda2.default.map(_ramda2.default.prop('name')), _ramda2.default.filter(function (item) {
